...
<head>
    ...
    <title>Takalo - Objets (backoffice)</title>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <h3 class="mb-0"><i class="fa fa-cube"></i> Objets</h3>
                    </div>
                            ...
                            <tbody>
                                <?php foreach ($objets as $o): ?>
                                    <tr>
                                        ...
                                        <td><?php echo htmlspecialchars($o->getTitre()); ?></td>
                                        <td><?php echo htmlspecialchars($o->getProprietaire()->getNom()); ?></td>
                                        <td><?php echo htmlspecialchars($o->getCategorie()->getLibelle()); ?></td>
                                        <td><?php echo htmlspecialchars($o->getStatut()->getLibelle()); ?></td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
                        </table>
