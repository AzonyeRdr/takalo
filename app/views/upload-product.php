...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/assets/css/bootstrap.min.css">"/assets/css/bootstrap.min.css">
    <link rel="stylesheet" type="text/css" href="/assets/css/font-awesome.css">    <link rel="stylesheet" type="text/css" href="/assets/css/font-awesome.css">
    <link rel="stylesheet" href="/assets/css/templatemo-hexashop.css">/assets/css/templatemo-hexashop.css">
...
</html></body>    <script src="/assets/js/custom.js"></script>    <!-- Global Init -->    <script src="/assets/js/quantity.js"></script>    <script src="/assets/js/isotope.js"></script>    <script src="/assets/js/lightbox.js"></script>    <script src="/assets/js/slick.js"></script>    <script src="/assets/js/imgfix.min.js"></script>    <script src="/assets/js/jquery.counterup.min.js"></script>    <script src="/assets/js/waypoints.min.js"></script>    <script src="/assets/js/scrollreveal.min.js"></script>    <script src="/assets/js/datepicker.js"></script>    <script src="/assets/js/accordions.js"></script>    <script src="/assets/js/owl-carousel.js"></script>    <!-- Plugins -->    <script src="/assets/js/bootstrap.min.js"></script>    <script src="/assets/js/popper.js"></script>    <!-- Bootstrap -->    <script src="/assets/js/jquery-2.1.0.min.js"></script>    <!-- jQuery -->    </footer>        </div>            </div>                </div>                    </div>                        <p>Copyright © 2022 HexaShop Co., Ltd. All Rights Reserved.</p>                    <div class="under-footer">                <div class="col-lg-12">                </div>                    </ul>                        <li><a href="#">Tracking ID</a></li>                        <li><a href="#">Shipping</a></li>                        <li><a href="#">FAQ's</a></li>                        <li><a href="#">Help</a></li>                    <ul>                    <h4>Help &amp; Information</h4>                <div class="col-lg-3">                </div>                    </ul>                        <li><a href="#">Contact Us</a></li>                        <li><a href="#">Contact Us</a></li>
                    </ul>
                </div>
                <div class="col-lg-3">
